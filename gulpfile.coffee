...
gulp.task 'kraken', ['sprites-deploy'], ->
  gulp.src(['dist/images/build/*', 'dist/images/*', '!dist/images/build/sprite.png',
    '!dist/images/build/sprite@2x.png'])
  .pipe(changed('dist/images'))
  .pipe kraken(
    key: secrets.kraken.key,
    secret: secrets.kraken.secret,
    lossy: true
  )
  return
